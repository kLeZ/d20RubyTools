...
Devise.setup do |config|
	...
	# config.secret_key =
# '6c15c0c09aa502be549376a2bf9ca1e12283b3d3f1f4ffea96cf69359de2a9e662b3c9778dd6d47173e2efffd27d94c361ff174c049de7abc860bf6d9897a7de'

	# ==> Mailer Configuration
	# Configure the e-mail address which will be shown in Devise::Mailer,
	# note that it will be overwritten if you use your own mailer class
	# with default "from" parameter.
	config.mailer_sender = ENV['DO_NOT_REPLY_ADDRESS'] if Rails.environment == 'production'
	config.mailer_sender = 'donotreply@d20webtools.org'
...
# re-encrypted.
	...
	# config.pepper =
# '6da2442cc5e19b59846725c0bc993650f13d3b48328ae69f03f8eb175ce36733d7a0d9b7f798c30a02fa6ffd8d135803a8a8a147da1b258f91e01767b4385dfb'
...
# in.
	...
	# Allow you to use another encryption algorithm besides bcrypt (default). You can
# use
